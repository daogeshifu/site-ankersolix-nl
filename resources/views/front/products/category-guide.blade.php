...
<section class="mb-12 mt-12 border-y border-[#dbdfe6] bg-white px-6 py-12 md:px-8">
    <div class="mx-auto grid max-w-[1280px] gap-6 lg:grid-cols-[minmax(0,1fr)_420px] lg:items-center">
        <div>
            ...
            <a href="{{ route('thuisbatterij-koopgids') }}" class="mt-5 inline-flex h-[46px] items-center gap-2 rounded-[10px] bg-primary px-5 text-[15px] font-bold text-white hover:bg-primary/90">
