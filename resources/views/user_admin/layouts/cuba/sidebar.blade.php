            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="pin-title  sidebar-main-title">
                        <div>
                            <h6>{{ trans('menu.menu') }}</h6>
                        </div>
                    </li>

                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav active" href="{{ route('user_admin.index') }}">
                            <svg>
                    ...
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav " href="{{ route('user_admin.user_info') }}">
                            <svg>
                                <use href="{{ asset('assets/svg/icon-sprite.svg#fill-user') }}"></use>
                            </svg>
                            <span>{{ trans('menu.account') }}</span>
                        </a>
                    </li>
                </ul>
            </div>
